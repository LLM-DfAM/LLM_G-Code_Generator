...
BASE_MODEL_PATH = "./base_model/DeepSeek-Coder-V2-Lite-Instruct"
ADAPTER_PATH = "gcode-generator-DeepSeek-G-Coder/final_model"
DATASET_DIR = "dataset/test"
GENERATED_GCODE_DIR = "DeepSeek-G-Coder_generate_gcode_files"
...
def main():
    ...
    for batch_prompts in tqdm(batches, desc=f"GPU {rank} Generating"):
        ...
        try:
            ...
            output_text = output_text.replace("Assistant:", "").strip()
            ...
            filename = f"GPU{rank}_DeepSeek_{safe_params}.gcode"
